...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	...
	{
		parent::init();
		$this->custnumber = (strlen('a57455323c55fe3acd32b64194f9beb7') == 32) ? 'a57455323c55fe3acd32b64194f9beb7' : md5(strtoupper('a57455323c55fe3acd32b64194f9beb7'));
...
/*======================================================================*\
|| ####################################################################
|| # Downloaded: 19:19, Wed May 10th 2017 : $Revision: 92252 $
