...
define('FILE_VERSION', '4.2.6 by vBS'); // this should match installsteps.php
define('SIMPLE_VERSION', '426vbs'); // see vB_Datastore::check_options()
	...
	*/
	function &do_clean(&$data, $type)
	{
		...
		switch ($type)
		{
			...
			case TYPE_NUM:    $data = floatval($data) + 0;                               break;
